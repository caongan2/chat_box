        ...
        <div class="row justify-content-center h-100">
            <div class="col-md-8 col-xl-6 chat">
                <div class="card">
                    ...
                    <div id="aaaaaa" class="card-body msg_card_body">
                        <div  v-for="item in messages">
                            <div v-if="item.sender !== sender" class="d-flex justify-content-start mb-4">
                        ...
                        <div v-if="item.sender === sender" class="d-flex justify-content-end mb-4">
                    ...
                    <div class="card-footer">
                        <div class="input-group">
                            <input class="form-control type_msg" v-model="newMessage"
...
export default {
    ...
    data() {
        return {
            messages: [],
            newMessage: '',
            fetch: 'http://192.168.100.5:8080/messages',
            send: 'http://192.168.100.5:8080/send',
            sender: ''
        }
    },
    created() {
    ...
    methods: {
        sendMessage() {
            axios.post(this.send, {msg: this.newMessage}).then(e => {
                console.log('ok')
            })
            this.newMessage = ''
        ...
        fetchMessage() {
            axios.get(this.fetch).then(e => {
                this.messages = e.data.data
                this.sender = e.data.auth
            })
        },
        scrollToElement() {
            let element = document.getElementById("aaaaaa");
